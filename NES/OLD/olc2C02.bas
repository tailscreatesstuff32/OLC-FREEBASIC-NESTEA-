...
#Include Once "nes/old/olc2C02.bi"
...
Dim col1 As uint32_t
		...
		'col1= GetColourFromPaletteRam(pal1, pixel)
				...
				'PSet pattables(i),((nTileX * 8 + (7 - col)),(nTileY * 8 + row)),GetColourFromPaletteRam(pal1, pixel)
					...
					mydata_pattables(i).mydata((nTileX * 8 + (7 - col)) + 128 * (nTileY * 8 + row)) = GetColourFromPaletteRam(pal1, pixel)
		...
		Next
	Next
 Return @mydata_pattables(i).mydata(0)
End Function 
...
If (cart_MirrorMode_NEW() =  VERTICAL) Then
