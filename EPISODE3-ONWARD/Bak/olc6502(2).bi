...
'		stkp-=1
'
'		'// Then Push the cpu cpustatus register to the stack
'		SetFlag(B, 0)
'		SetFlag(U, 1)
'		SetFlag(I, 1)
'		bus_write(&H0100 + stkp, cpu cpustatus)
'		stkp-=1 
'
...
'
'	SetFlag(B, 1)
'	cpu_write(&H0100 + stkp, cpu cpustatus) 
'	stkp-=1
'	SetFlag(B, 0) 
'
...
'	
'	cpu_write(&H0100 + stkp, cpu cpustatus or B or U) 
'	SetFlag(B, 0) 
'	SetFlag(U, 0) 
'	stkp-=1 
'	return 0 
